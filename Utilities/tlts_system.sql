...
ALTER TABLE `admin_log`
  ...
  ADD KEY `admin_log_ibfk_3` (`history_id`);
...
ALTER TABLE `admin_log`
  ...
  ADD CONSTRAINT `admin_log_ibfk_3` FOREIGN KEY (`history_id`) REFERENCES `request_history` (`history_id`);
...
ALTER TABLE `requests`
  ...
  ADD CONSTRAINT `requests_ibfk_3` FOREIGN KEY (`history_id`) REFERENCES `request_history` (`history_id`);
COMMIT;
